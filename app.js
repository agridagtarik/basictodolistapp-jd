...
const makeItDone = (target) => {
    ...
    target.className ="";
    target.classList.add("fa-solid", "fa-check-square");
...
const makeItTodo = (target) => {
    ...
    target.className ="";
    target.classList.add("fa-solid", "fa-square");
...
const createTodoItem = (text) => {
    ...
    todoItemCheck.classList.add("fa-solid", "fa-square");
    todoItemCheck.setAttribute("onclick","checkTodo(this)");
    const todoItemRemove = document.createElement("i");
    todoItemRemove.classList.add("fa-solid", "fa-trash-can");
...
const createDoneItem = (text) => {
    ...
    todoItemLi.innerHTML = text;
    const todoItemCheck = document.createElement("i");
    todoItemCheck.classList.add("fa-solid", "fa-check-square");
    ...
    array.forEach ((item) => {
        switch (filter) {
            case "0" :
                ...
                todoFilter.classList.add("fa-solid","fa-square");
            ...
            case "2" :
                todoFilter.className = "";
                todoFilter.classList.add("fa-solid","fa-check-square");
